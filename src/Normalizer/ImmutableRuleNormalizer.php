...
class ImmutableRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Gyroscops\\Harbor\\Api\\Model\\ImmutableRule';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Gyroscops\\Harbor\\Api\\Model\\ImmutableRule';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Gyroscops\Harbor\Api\Model\ImmutableRule();
        ...
        if (\array_key_exists('tag_selectors', $data) && $data['tag_selectors'] !== null) {
            ...
            foreach ($data['tag_selectors'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'Gyroscops\\Harbor\\Api\\Model\\ImmutableSelector', 'json', $context);
            }
        ...
        if (\array_key_exists('scope_selectors', $data) && $data['scope_selectors'] !== null) {
            ...
            foreach ($data['scope_selectors'] as $key_1 => $value_2) {
                ...
                foreach ($value_2 as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, 'Gyroscops\\Harbor\\Api\\Model\\ImmutableSelector', 'json', $context);
                }
