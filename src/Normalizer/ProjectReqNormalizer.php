...
class ProjectReqNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Harbor\\Api\\Model\\ProjectReq';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Harbor\\Api\\Model\\ProjectReq';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Harbor\Api\Model\ProjectReq();
        ...
        if (\array_key_exists('cve_whitelist', $data)) {
            $object->setCveWhitelist($this->denormalizer->denormalize($data['cve_whitelist'], 'Harbor\\Api\\Model\\CVEWhitelist', 'json', $context));
        }
        if (\array_key_exists('storage_limit', $data)) {
            $object->setStorageLimit($data['storage_limit']);
        }
        if (\array_key_exists('metadata', $data)) {
            $object->setMetadata($this->denormalizer->denormalize($data['metadata'], 'Harbor\\Api\\Model\\ProjectMetadata', 'json', $context));
        }
        return $object;
    }
    /**
