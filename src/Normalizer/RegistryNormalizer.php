...
class RegistryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Harbor\\Api\\Model\\Registry';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Harbor\\Api\\Model\\Registry';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Harbor\Api\Model\Registry();
        ...
        if (\array_key_exists('credential', $data)) {
            $object->setCredential($this->denormalizer->denormalize($data['credential'], 'Harbor\\Api\\Model\\RegistryCredential', 'json', $context));
        }
