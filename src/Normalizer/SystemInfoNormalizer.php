...
class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Harbor\\Api\\Model\\SystemInfo';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Harbor\\Api\\Model\\SystemInfo';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Harbor\Api\Model\SystemInfo();
        ...
        if (\array_key_exists('storage', $data)) {
            ...
            foreach ($data['storage'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Harbor\\Api\\Model\\Storage', 'json', $context);
            }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getStorage()) {
            $values = array();
            foreach ($object->getStorage() as $value) {
